...
# CONSTANTS
#
from viewer.__data__ import PART_TITLE_DISK
...
class SelectDisks:
    """
    Represents the disks selelction screen
    """
    def __init__(self, screen, disks, selectedDisks=[]):
        ...
        self._diskTree = CheckboxTree(DISK_TREE_HEIGHT, scroll=1)
        ...
        # Build form
        self._form = GridForm(self._screen, PART_TITLE_DISK.localize(), 1, 5)
