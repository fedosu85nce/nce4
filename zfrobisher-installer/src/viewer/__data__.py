...
ERROR_NO_DISK_FOUND = _("No disk found")
ERROR_NO_DISK_FOUND_MSG = _("No disks were found in the system.")
SELECT_ID = _("ID:")
SELECT_SIZE = _("Size")
...
# select disks form
PART_TITLE_DISK = _("Disk Selection")
PART_LABEL_DISKDESC = _("Please select the disks you want to install on.")
